...
public class Soft1714080902214Activity5 extends Activity  {


    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.soft_1714080902214_activity5);
        Log.i("Activity05", "onCreate()");
    }
    ...
    protected void onResume() {
        ...
        try {
            String s = getstream();
            List<User> users = userService.getuser(Soft1714080902214Activity5.class.getClassLoader().getResourceAsStream(s));
