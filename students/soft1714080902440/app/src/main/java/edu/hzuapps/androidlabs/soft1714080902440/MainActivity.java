...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("001","");   //001是代号，对应Main2Activity里的001
            startActivityForResult(intent,0x01);     //这是请求
        }
        });
    ...
    private void showDialogTipUserRequestPermission() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("存储权限不可用")
                .setMessage("由于该天气通需要获取存储空间，为你存储个人信息；\n否则，您将无法正常使用天气通")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==0x01&&resultCode==0x02){
            ...
            int i=data.getIntExtra("002",404);
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.content:
                //加入网络图片地址
                new Task().execute("http://b.zol-img.com.cn/sjbizhi/images/9/1080x1920/1535718802209.jpg");
                break;
