...
public class Utils {
    public static void startAnim(LinearLayout mImgUp,LinearLayout mImgDn){
        ...
        new Thread(){
            public void run(){
                try {
                    ...
                    soundPoolMap.put(1,pool.load(context.getAssets().openFd("sound/dudu.mp3"),1));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
