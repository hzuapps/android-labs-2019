...
public class fifth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fifth);//获取布局文件中的控件
        ...
        public void onClick(View v) {
            switch(v.getId()) {
                case R.id.btn_save:
                    ...
                    Toast.makeText(fifth.this,"数据保存成功",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_read:
                    String content="";
                    try {
                    ...
                    Toast.makeText(fifth.this,"保存的数据是："+content,Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
