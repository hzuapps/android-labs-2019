...
public class Soft1714080902413Downloader {
    public static final String TAG = Soft1714080902413Downloader.class.getSimpleName();
    ...
    public Soft1714080902413Downloader(@NonNull OnImageDownloadListener listener) {
