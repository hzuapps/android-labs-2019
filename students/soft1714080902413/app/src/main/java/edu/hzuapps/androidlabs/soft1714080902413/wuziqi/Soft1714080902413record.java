...
public class Soft1714080902413record extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_first:
                Intent fir_intent =new Intent(Soft1714080902413record.this,Soft1714080902413Activity.class);
                startActivity(fir_intent);break;
            case R.id.btn_refresh:
                Intent intent =new Intent(Soft1714080902413record.this, Soft1714080902413record.class);
