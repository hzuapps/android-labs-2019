package edu.hzuapps.androidlabs.soft1714080902108;
 ...
 */
public class DNFLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(DNFLogin.this,
