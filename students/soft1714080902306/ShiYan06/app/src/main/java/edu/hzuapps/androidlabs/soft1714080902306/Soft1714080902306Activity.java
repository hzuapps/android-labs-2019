...
public class Soft1714080902306Activity extends AppCompatActivity {
    ...
    private Handler handler=new Handler(){
        public void handleMessage(android.os.Message msg){
            if(msg.what==CHANGE_UI){
                ...
                Toast.makeText(Soft1714080902306Activity.this, "显示图片错误",Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soft1714080902306);
