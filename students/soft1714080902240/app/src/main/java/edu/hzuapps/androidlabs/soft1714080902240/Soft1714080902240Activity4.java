...
public class Soft1714080902240Activity4 extends AppCompatActivity {
    private TextView edittext;

    public static final String DIRECTORY = "demo";
    public static final String FILENAME = "file_demo.txt";
    public static final String TAG = Soft1714080902240Activity4.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soft17140809022404);

        boolean conn = ConnectionUtil.isConn(Soft1714080902240Activity4.this);
        //如果没有网络
        if (!conn) {
            //跳转到设置网络的界面
            ConnectionUtil.setNetworkMethod(Soft1714080902240Activity4.this);
        } else {
        }
...
//            dir.mkdirs();
   ...
   //     try {
    ...
    //   }
        ...
        Toast.makeText(Soft1714080902240Activity4.this,"保存成功", 0).show();
    }
