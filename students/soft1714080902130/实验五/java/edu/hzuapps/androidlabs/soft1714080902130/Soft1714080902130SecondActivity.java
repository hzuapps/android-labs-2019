        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.save_button:
                    ...
                    try {
                        fos=openFileOutput(SaveFileName,MODE_APPEND);
                        fos.write(saveInfo.getBytes());
                        fos.close();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    Toast.makeText(Soft1714080902130SecondActivity.this,"数据保存成功",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.load_button:
                    ...
                    Toast.makeText(Soft1714080902130SecondActivity.this,"保存活动为："+content,Toast.LENGTH_SHORT).show();
                    break;
                default:
            }
        }
