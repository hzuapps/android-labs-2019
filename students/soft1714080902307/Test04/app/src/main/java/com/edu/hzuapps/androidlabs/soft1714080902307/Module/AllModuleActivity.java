...
import com.edu.hzuapps.androidlabs.soft1714080902307.Function.FirstFunctionActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(AllModuleActivity.this, FirstFunctionActivity.class);
