    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Return_page.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MainActivity7.this, MainActivity8.class);//也可以这样写intent.setClass(MainActivity.this, OtherActivity.class);
        ...
        switch (Show_Choice)
        {
            ...
            case TAKE_PHOTO:{
                ...
                if (Build.VERSION.SDK_INT < 24) {
                    ...
                    imageUri = FileProvider.getUriForFile(MainActivity7.this, "com.MapScanner.MapScanner", outputImage);
                }
                // 启动相机程序
            ...
            {
                //如果没有权限则申请权限
                if (ContextCompat.checkSelfPermission(MainActivity7.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
