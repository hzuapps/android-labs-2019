...
public class MainActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Turn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MainActivity9.this, MainActivity8.class);//也可以这样写intent.setClass(MainActivity.this, OtherActivity.class);
    ...
    private void initVideoPath() {
        if (ContextCompat.checkSelfPermission(MainActivity9.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity9.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        }
