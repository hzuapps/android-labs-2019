...
public class MainActivity5 extends AppCompatActivity implements View.OnClickListener {
    ...
    private MainActivity6 mFileDownloader;
    ...
    private void downloadImages() {
        // 创建下载器
        mFileDownloader = new MainActivity6(new MainActivity6.OnImageDownloadListener() {
            @Override
            ...
            public void onComplete(Bitmap bitmap, String imageUrl) {
                ...
                // 将文件保存到磁盘中
                MainActivity6.writeToDisk(imageFile, bitmap, new MainActivity6.OnBitmapSaveListener() {
                    @Override
                    public void onBitmapSaved() {
                        Toast.makeText(MainActivity5.this, "文件已保存: " + imageFile.getAbsolutePath(), Toast.LENGTH_LONG).show();
                    }
                    @Override
