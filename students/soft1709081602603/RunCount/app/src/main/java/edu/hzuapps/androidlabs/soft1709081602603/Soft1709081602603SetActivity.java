...
public class Soft1709081602603SetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soft1709081602603_set);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_save:
                    ...
                    Toast.makeText(Soft1709081602603SetActivity.this,"提交成功",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_read:
                    String content="";
                    try {
                    ...
                    Toast.makeText(Soft1709081602603SetActivity.this,"提交的内容是"+content,Toast.LENGTH_SHORT).show();
                    break;
                default:
            }
        }
